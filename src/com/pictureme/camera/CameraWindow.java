...
//					mPercent = mDetection.getPercent();
					...
					mCallBack.onDetect(mBuffer, CameraWindow.this);

//					mFlowControl.block(1000);
...
//					mCallBack.onDetect(mTime, mBuffer, CameraWindow.this);
...
//				mCamera = Camera.open(CameraImplements.validCamera(camera));
	...
	private void closeCamera() {
		...
		try {
			...
			Log.d(LOG, "Can Not Close Camerna " + e.getLocalizedMessage());
		}
	}
	...
	public interface CameraCallBack {
		...
		int onDetect(FrameBuffer frame, CameraWindow camera);
		void onFinish();
